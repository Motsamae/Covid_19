...
export class KenyaComponent implements OnInit {
  ...
  getDailyReportByCountryNameAndDate() {
    ...
    forkJoin(this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[0]), this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[1]),
      this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[2]), this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[3]),
      this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[4]), this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[5]),
      this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[6]), this.qedCovidService.getDailyReportByCountryName('kenya', overAllDateList[7]),
      this.qedCovidService.getDailyReportForProvinces()).subscribe(([dayOne, dayTwo, dayThree, dayFour, dayFive, daySix, daySeven, dayEight, gautengData]:
        ...
        console.log(dayOne);
        console.log(this.qedCovidService.dailyReportByCountryName['kenya']);
        const newDailyReport = this.qedCovidService.dailyReportByCountryName['kenya'].filter((x: any) => x !== undefined)
        for (var i = 0; i < overAllDateList.length; i++) {
          if (this.qedCovidService.dailyReportByCountryName['kenya'][i]) {
        ...
        this.tiles[0].text = this.tiles[0].text + ' :' + this.qedCovidService.dailyReportByCountryName['kenya'][0].cases.critical;
        this.tiles[1].text = this.tiles[1].text + ' :' + this.qedCovidService.dailyReportByCountryName['kenya'][0].cases.active;
        this.tiles[2].text = this.tiles[2].text + ' :' + this.qedCovidService.dailyReportByCountryName['kenya'][0].deaths.total;
        this.tiles[3].text = this.tiles[3].text + ' :' + this.qedCovidService.dailyReportByCountryName['kenya'][0].tests.total;
      }, function (err: any) {
        console.log(err);
      });

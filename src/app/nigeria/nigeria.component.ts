...
export class NigeriaComponent implements OnInit {
  ...
  getDailyReportByCountryNameAndDate() {
    ...
    forkJoin(this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[0]), this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[1]),
      this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[2]), this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[3]),
      this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[4]), this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[5]),
      this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[6]), this.qedCovidService.getDailyReportByCountryName('nigeria', overAllDateList[7]),
      this.qedCovidService.getDailyReportForProvinces()).subscribe(([dayOne, dayTwo, dayThree, dayFour, dayFive, daySix, daySeven, dayEight, gautengData]:
        ...
        console.log(dayOne);
        console.log(this.qedCovidService.dailyReportByCountryName['nigeria']);
        const newDailyReport = this.qedCovidService.dailyReportByCountryName['nigeria'].filter((x: any) => x !== undefined)
        for (var i = 0; i < overAllDateList.length; i++) {
          if (this.qedCovidService.dailyReportByCountryName['nigeria'][i]) {
        ...
        this.tiles[0].text = this.tiles[0].text + ' :' + this.qedCovidService.dailyReportByCountryName['nigeria'][0].cases.critical;
        this.tiles[1].text = this.tiles[1].text + ' :' + this.qedCovidService.dailyReportByCountryName['nigeria'][0].cases.active;
        this.tiles[2].text = this.tiles[2].text + ' :' + this.qedCovidService.dailyReportByCountryName['nigeria'][0].deaths.total;
        this.tiles[3].text = this.tiles[3].text + ' :' + this.qedCovidService.dailyReportByCountryName['nigeria'][0].tests.total;
      }, function (err: any) {
        console.log(err);
      });
